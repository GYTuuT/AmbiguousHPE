...
class Pytorch3DRenderer(torch.nn.Module):
    ...
    def __init__(self,
        ...
        **kwargs,
        ...
        self.fix_R, self.fix_T = look_at_view_transform(dist=1.0, elev=0., azim=180., up=((0, -1, 0),))
        self.default_cameras = dict(type='ortho', cam=OrthographicCameras(device=self.device, R=self.fix_R, T=self.fix_T))
